...
public class QueryPanel extends JPanel {
    ...
    public QueryPanel(ApplicationController controller) throws SQLException {
        ...
        add(panel1);
        ButtonPromoBrand buttonPromoBrandPanel = new ButtonPromoBrand(this, controller, refBrandComboBox);
        buttonQuery1.addActionListener(buttonPromoBrandPanel);
        ...
        modelAffairs.addAll(idsAffairs);
        ...
        ButtonAffairDetails buttonAffairDetails = new ButtonAffairDetails(this, controller, refAffairComboBox);
        buttonQuery2.addActionListener(buttonAffairDetails);
        ...
        ButtonExpiredBatches buttonExpiredBatches = new ButtonExpiredBatches(this, controller, dateDay, dateMonth, dateYear);
        buttonQuery3.addActionListener(buttonExpiredBatches);
