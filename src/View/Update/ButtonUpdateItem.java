...
public class ButtonUpdateItem implements ActionListener {
    ...
    private JTextField nameText, catalogPriceText, packagingText, vatText, stockQuantityText, thresholdLimitText, reductionPointsText;
    ...
    public ButtonUpdateItem(JTextField nameText,
                            ...
                            JCheckBox optionalButtonAutomaticOrder,
                            JCheckBox optionalButtonSaleDate, JCheckBox optionalButtonReductionPoint, ApplicationController controller, String codeItem,
                            JPanel main){
    ...
    public void setUpdateValues()throws AddCodeException, AddIntException, AddBigDecimalException, AddIntException{
        ...
        if(optionalButtonReductionPoint.isSelected()) {
            if (reductionPointsText.getText().matches("[0-9]{1,}\\.{0,1}[0-9]{0,}"))
                updateValues.put("reduction_points", reductionPointsText.getText());
            else
